...
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](t.me/ROLSORS)}\n•["..LeDew_Msg.."] \n")
end
end,nil)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})
return false
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](t.me/ROLSORS)}\n• الملصق الذي ارسلته تم منعه من المجموعه \n" )
end
end,nil)
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return false
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@ROLSORS','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/ROLSORS) •'
end
send(msg.chat_id_, msg.id_,Text)
end
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> محيبس
•━━━━━━•
- Ch [𝘊𝘏 𝘚𝘖𝘜𝘙𝘊𝘌 - SoUrCe](https://t.me/ROLSORS)
]]
...
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](t.me/ROLSORS)}\n•["..LeDewAbot.."] \n")
end
end,nil)
DeleteMessage(msg.chat_id_,{[0] = data.message_id_})
return false
...
if text == 'كسمك' or text == 'احظرني' then
if not database:get(bot_id..'Cick:Me'..msg.chat_id_) then
if Can_or_NotCan(msg.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n• عذرا عزيزي لا يمكنني طرد( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
