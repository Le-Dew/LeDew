...
sudo_users = {SUDO,1651869891,bot_id}
...
if tonumber(user_id) == tonumber(1651869891) then
var = true
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'Elite_f')..')'
...
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'Elite_f')..') '
status  = '\n تم ترقيته مطور في البوت'
...
if LeDew1_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
send(msg.chat_id_, msg.id_,'• العضو> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Elite_f')..') \n •'..LeDew1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})
return false
end,nil)
end
...
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/Elite_f)}\n•["..LeDew_Msg.."] \n")
end
end,nil)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})
return false
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/Elite_f)}\n• الملصق الذي ارسلته تم منعه من المجموعه \n" )
end
end,nil)
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return false
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@Elite_f','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
if text == '@lIBlII' or text == '@Elite_f' or text == 'عبدالله ' then
Text = [[
 مبرمج السورس
]]
send(msg.chat_id_, msg.id_,Text)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Elite_f')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'Elite_f')..') \n*•تم قفـل الدردشه*\n')
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Elite_f')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'Elite_f')..') \n*تم قفـل الالعاب*\n')
end,nil)
...
if result.sender_user_id_ == tonumber(1651869891) then
...
if result.id_ == tonumber(1651869891) then
send(msg.chat_id_, msg.id_, "•  لا يمكنك حظر مبرمج السورس \n")
return false
end
usertext = '\n•العضو > ['..result.title_..'](t.me/'..(username or 'Elite_f')..')'
...
local UserName = (b.username_ or "Elite_f")
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n• العضو > ['..result.title_..'](t.me/'..(text1[3] or 'Elite_f')..')'..'\n تم رفعه '..text1[2]..' هنا')
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/Elite_f) •'
end
send(msg.chat_id_, msg.id_,Text)
end
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> محيبس
•━━━━━━•
- Ch [𝘊𝘏 𝘚𝘖𝘜𝘙𝘊𝘌 - SoUrCe](https://t.me/Elite_f)
]]
...
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](T.ME/Elite_f)}\n•["..LeDewAbot.."] \n")
end
end,nil)
DeleteMessage(msg.chat_id_,{[0] = data.message_id_})
return false
