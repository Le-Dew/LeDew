...
LeDew_Msg = 'عود متفاعل' 
elseif msgs > 1000 then 
LeDew_Msg = 'متفاعل كفو' 
elseif msgs > 1500 then 
LeDew_Msg = 'متفاعل جدا' 
elseif msgs > 2000 then 
LeDew_Msg = 'طاك مال تفاعل'  
elseif msgs > 4000 then 
LeDew_Msg = 'مخبل بلتفاعل' 
elseif msgs > 4500 then 
LeDew_Msg = 'مدمن تفاعل' 
elseif msgs > 5500 then 
LeDew_Msg = 'طاك' 
elseif msgs > 7000 then 
LeDew_Msg = 'يطك بالكاع' 
...
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..LeDewChengName..']')
...
if text == '@IIIIIX' or text == '@DewSc1' or text == 'مودي البدراني' then
Text = [[
...
if not database:get(bot_id..'LeDew:Reply:Mute'..msg.chat_id_) or database:get(bot_id.."AL:Vbv:stats")== "✔" then
...
if text == 'تفعيل ردود البوت' and Mod(msg) and database:get(bot_id.."AL:Vbv:stats") == "✔" then
database:del(bot_id..'LeDew:Reply:Mute'..msg.chat_id_,"open")
send(msg.chat_id_, msg.id_,'•تم تفعيل ردود البوت')
return false
end
if text == 'تعطيل ردود البوت' and Mod(msg) and database:get(bot_id.."AL:Vbv:stats") == "✔" then
database:set(bot_id..'LeDew:Reply:Mute'..msg.chat_id_,"close")
